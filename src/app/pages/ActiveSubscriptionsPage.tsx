          ...
          <table className="w-full text-right border-collapse">
            <thead>
              <tr style={{ background: 'var(--secondary)', borderBottom: '1px solid var(--border)' }}>
                <th className="p-4 text-[12px] font-bold" style={{ color: 'var(--primary)' }}>المنشأة</th>
                <th className="p-4 text-[12px] font-bold" style={{ color: 'var(--primary)' }}>الباقة</th>
                <th className="p-4 text-[12px] font-bold" style={{ color: 'var(--primary)' }}>تاريخ البدء</th>
                <th className="p-4 text-[12px] font-bold" style={{ color: 'var(--primary)' }}>الحالة</th>
                <th className="p-4 text-[12px] font-bold" style={{ color: 'var(--primary)' }}>الإجراءات</th>
              </tr>
            </thead>
            <tbody>
              {filtered.map((sub, i) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-2">
                       <span className="text-xs px-2 py-1 rounded font-bold" style={{ background: 'var(--primary-glass)', color: 'var(--primary)' }}>
